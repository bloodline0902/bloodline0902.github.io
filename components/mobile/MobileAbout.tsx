        ...
        <div className="py-6">
          ...
          <div className="mb-8 flex flex-col items-center gap-3 text-center">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a
                href="https://www.linkedin.com/in/tonyh2021/"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 rounded-lg bg-blue-50 px-3 py-1.5 text-sm font-medium text-blue-700 transition-colors hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/30"
              >
                <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            {aboutBlocks.map((block, i) => {
              ...
              if (block.kind === "attribution")
                return (
                  <p key={i} className="text-right text-sm text-gray-500 not-italic">
                    {block.text}
                  </p>
                );
              return (
                <p key={i} className={block.emphasis === "small" ? "text-sm" : undefined}>
                  {block.text}
                </p>
              );
            })}
