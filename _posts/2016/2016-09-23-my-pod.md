...
可以参考我的文件 [ImagePicker-Objective-C.podspec](https://github.com/bloodline0902/ImagePicker-Objective-C/blob/master/ImagePicker-Objective-C.podspec)。
...
### 代码：
文章中的代码都可以从我的GitHub [`ImagePicker-Objective-C`](https://github.com/bloodline0902/ImagePicker-Objective-C)找到。
